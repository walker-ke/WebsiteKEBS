...
<div class="ui container fluid">
	...
	<form action="<?php echo r2('index.php?ext='.$this->get('ext_name').'&act=validateinstall'); ?>" method="post" name="admin_form" id="admin_form" class="ui form">
		<div class="field">
			...
			<small><?php el('Do not change the domain name unless you are planning to move the website later to a different domain or if your website is accessible under multiple domains.'); ?></small>
		</div>
		<!--
		...
		<div class="field">
			...
			<small><?php el('You need this key when your website can not connect to chronoengine.com'); ?></small>
		</div>
