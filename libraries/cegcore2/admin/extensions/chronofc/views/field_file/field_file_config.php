...
<div class="ui segment tab views-tab active" data-tab="view-<?php echo $n; ?>">
	...
	<div class="ui bottom attached tab segment active" data-tab="view-<?php echo $n; ?>-general">
		...
		<div class="equal width fields">
			...
			<div class="field">
				<label><?php el('Max size'); ?></label>
				<input type="text" value="1000" name="Connection[views][<?php echo $n; ?>][max_size]">
				<small><?php el('File maximum allowed size in KB'); ?></small>
			</div>
		</div>
		<div class="equal width fields">
			<div class="field">
				<label><?php el('Extension error'); ?></label>
				<input type="text" value="File extension is not permitted" name="Connection[views][<?php echo $n; ?>][file_extension_error]">
				<small><?php el('Error to display when the file extension is not permitted'); ?></small>
			</div>
			<div class="field">
				<label><?php el('Size error'); ?></label>
				<input type="text" value="File size overlimit" name="Connection[views][<?php echo $n; ?>][max_size_error]">
				<small><?php el('Error to display when the file size is overlimit'); ?></small>
			</div>
		</div>
