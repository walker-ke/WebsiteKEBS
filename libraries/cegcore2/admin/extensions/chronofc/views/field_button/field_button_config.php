		...
		<div class="two fields">
			<div class="four wide field">
				...
				<select name="Connection[views][<?php echo $n; ?>][params][type]" class="ui fluid dropdown">
					...
					<option value="repeater_add"><?php el('Repeater Add'); ?></option>
					<option value="repeater_remove"><?php el('Repeater Remove'); ?></option>
					<option value="partitions_forward"><?php el('Partitions Forward'); ?></option>
					<option value="partitions_backward"><?php el('Partitions Backward'); ?></option>
					<option value="partitions_finish"><?php el('Partitions Finish'); ?></option>
				</select>
			</div>
