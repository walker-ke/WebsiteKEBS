	...
	<div class="ui bottom attached tab segment active" data-tab="function-<?php echo $n; ?>-general">
		...
		<div class="ui segment active" data-tab="function-<?php echo $n; ?>">
			...
			<div class="field">
				...
				<textarea name="Connection[functions][<?php echo $n; ?>][content]" rows="8" data-editor="0" id="tcpdf_editor<?php echo $n; ?>"></textarea>
			</div>
		...
		<div class="equal width fields">
			<div class="field">
				<div class="ui checkbox toggle">
					<input type="hidden" name="Connection[functions][<?php echo $n; ?>][disable_pdf_header]" data-ghost="1" value="">
					<input type="checkbox" class="hidden" name="Connection[functions][<?php echo $n; ?>][disable_pdf_header]" value="1">
					<label><?php el('Disable Header'); ?></label>
					<small><?php el('Disable PDF pages headers'); ?></small>
				</div>
			</div>
			<div class="field">
				<div class="ui checkbox toggle">
					<input type="hidden" name="Connection[functions][<?php echo $n; ?>][disable_pdf_footer]" data-ghost="1" value="">
					<input type="checkbox" class="hidden" name="Connection[functions][<?php echo $n; ?>][disable_pdf_footer]" value="1">
					<label><?php el('Disable Footer'); ?></label>
					<small><?php el('Disable PDF pages footers'); ?></small>
				</div>
			</div>
		</div>
