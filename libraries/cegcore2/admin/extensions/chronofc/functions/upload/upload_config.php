	...
	<div class="ui bottom attached tab segment active" data-tab="function-<?php echo $n; ?>-general">
		...
		<div class="ui segment active" data-tab="function-<?php echo $n; ?>">
			...
			<div class="field easy_disabled private_config">
				...
				<small><?php el('If not empty then the resulting value will used as the file name, you can use {var:%s.file.name} and {var:%s.file.extension} to get the file name and extension.', [$this->data('Connection.functions.'.$n.'.name'), $this->data('Connection.functions.'.$n.'.name')]); ?></small>
			</div>
