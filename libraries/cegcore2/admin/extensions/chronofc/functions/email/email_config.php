	...
	<div class="ui bottom attached tab segment active" data-tab="function-<?php echo $n; ?>-general">
		...
		<div class="ui segment active" data-tab="function-<?php echo $n; ?>">
			...
			<div class="equal width fields">
				...
				-->
				<div class="field">
					<label><?php el('Auto content'); ?></label>
					<select name="Connection[functions][<?php echo $n; ?>][autoemail]" class="ui fluid dropdown">
						<option value="2"><?php el('Include Pages templates'); ?></option>
						<option value="1"><?php el('Include Email enabled fields'); ?></option>
						<option value=""><?php el('Disabled'); ?></option>
					</select>
					<small><?php el('Select the auto included email content, the auto content will be appended to the email body or you can use {AUTO_FIELDS} where you want it placed.'); ?></small>
				</div>
				<div class="field">
