...
<div class="ui tab segment" data-tab="function-<?php echo $n; ?>-models-<?php echo $model_number; ?>">
	...
	<div class="field">
		<label><?php el('Alternative Primary key'); ?></label>
		<input type="text" value="" name="Connection[functions][<?php echo $n; ?>][models][<?php echo $model_number; ?>][pkey]">
		<small><?php el('An alternative field name in the related model, to be used for matching its values against the foreign key of this table.'); ?></small>
	</div>
	...
	<div class="two fields">
		...
		<div class="field">
			...
			<textarea placeholder="<?php el('Multiline list or PHP code to return an array'); ?>" name="Connection[functions][<?php echo $n; ?>][models][<?php echo $model_number; ?>][group]" rows="3"></textarea>
