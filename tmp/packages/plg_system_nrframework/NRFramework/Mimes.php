...
class Mimes
{
	...
	/**
	 * Test whether the given mime type is in the allowed types.
	 *
	 * @param	mixed	$allowed_types	Can be a list of comma separated types or an array of types
	 * @param	string	$mime			The mime type to check
	 *
	 * @return	mixed	Null on failure, true on success
	 */
	public static function check($allowed_types, $mime)
	{
		$allowed_types = is_array($allowed_types) ? $allowed_types : array_map('trim', explode(',', $allowed_types));
		...
		foreach ($allowed_types as $allowed_type)
		{
			...
			$allowed_type = strpos($allowed_type, '/') === false ? self::guessTypeFromExtension($allowed_type) : $allowed_type;
