...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
  ...
  <tr>
    <td  colspan="5"><span style="font-size:10pt; font-weight:bold">Suspended Firms :
        <? 
...
$queryCount = "SELECT * FROM suspended_firms";
...
if($numrows == 0)
{
    echo 'Sorry, We Have no Certified Firm That Meet the Given Criteria.</br>';
     echo 'Please Use the Links on the Left to Select One.';
    exit();
}
 ...
 ?>      </td>
  ...
  <tr style="border-bottom-width:thin; border-bottom-color:#000066; border-bottom-style:dotted">
    ...
    <td width="100" valign="top"><span style="font-family:arial,sans-serif,Halvetica;font-size:8pt;"><?php echo $info['firm']; ?></span></td>
        ...
        <td width="105"><span style="font-family:arial,sans-serif,Halvetica;font-size:8pt;"><?php echo $info['suspension_date']; ?></span></td>
      	<td width="105"><span style="font-family:arial,sans-serif,Halvetica;font-size:8pt;"><?php echo $info['scheme']; ?></span></td>
