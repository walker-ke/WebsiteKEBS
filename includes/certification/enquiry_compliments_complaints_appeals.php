...
if($result){
mail("customercare@kebs.org", $subject, $message, $from);
//mail("wkibii@gmail.com", $subject, $message, $from);
mail("kibiiw@kebs.org", $subject, $message, $from);//mail("kibiiw@kebs.org", $subject, $message, $from);
...
?>
  ...
  <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" >
		...
		<div align ="center" style="font-weight:bold; width:100%"><fieldset style="color:#006699;font-size:11pt; background-color:#CCCCCC; border-color:#000000; border-width:1px; line-height:20px">
      ...
      <table width="100%" border="0">
        ...
        <tr>
          ...
          <td><table width="300" border="0" cellspacing="0" cellpadding="2">
            ...
            <tr>
              <td width="76" style="color:#006; font-weight:bold;">Telephone Number:</td>
              <td width="216"><input name='telephone' id='telephone' style='width:150px;height:20px;' value='' size="20" /></td>
            </tr>
            <tr>
              <td style="color:#006; font-weight:bold;">Email Address:</td>
              <td><input type="email" name='email' id='email' style='width:200px;height:20px;' value='' size="20" /></td>
            </tr>
            <tr>
              <td style="color:#006; font-weight:bold;">Fax Number:</td>
...
<label>
  ...
  <span style="color:#006; font-weight:bold; vertical-align:middle">Compliment</span></label>
&nbsp;&nbsp;
<label>
...
<label>
  ...
  <span style="color:#006; font-weight:bold">Appeal</span></label></fieldset></td>
        ...
        <tr><td colspan="2" style="color:#006; font-weight:bold;">Details :<span style="color:red"></tr>
        <tr>
          <td colspan="2" style="color:#006; font-weight:bold;"><span style="color:red">
