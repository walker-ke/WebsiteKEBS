...
$message = " $todayis\n
Dear KEBS CB\n 
A Customer by the name $respname has filled in a feedback form on the website through the reference number <span  style='font-weight:bold'>$ref</span>\n 
From: $namers ($email) \r";
...
<span style="font-weight:100; font-size:10pt; text-align:center">QUESTIONNAIRE FOR CUSTOMER FEEDBACK</span></div>
 ...
 <legend style="color:#0066CC"><strong>SECTION A (OTIONAL): CUSTOMER DETAILS</strong></legend>
                  ...
                  <tr>
                    <td>Tel. No. </td>
                    <td><input name="telephoneno" type="text" id="telephoneno" size="15" /></td></tr>
                    <tr>
                    <td>Email</td><td>
...
<tr><td>
	...
	<table width="100%" border="0" cellspacing="3" cellpadding="0">
      <tr>
        <td  valign="top">Is your management system certified by the KEBS CB?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
Yes 
          <blockquote>
			...
			<legend><span style="color:#FF0000; font-weight:bold">If yes, to what standard?</span></legend>
                <input name="standards[]" type="checkbox" id="standards[]" value="ISO 9001">
                ISO 9001<br>
                <input type="checkbox" name="standards[]" value="ISO 14001"> 
                ISO 14001<br>
                <input type="checkbox" name="standards[]" value="ISO 22000"> 
                ISO 22000<br>
                <input type="checkbox" name="standards[]" value="HACCP"> 
                HACCP 
                <br />
                <input type="checkbox" name="standards[]" value="OHSAS" />
                OHSAS<br />
                <input type="checkbox" name="standards[]" value="Other Standards" />
                Other, Specify 
...
<span style="color:#333333; font-weight:bold" id="parent4">(If yes, it is mandatory you complete section A to enable us contact you) </span><br/><span style="color:#333333; font-weight:bold" id="parent5">If no, Kindly explain<br /><textarea name="explanation" cols="45" rows="1" id="explanation" style="font-size:10pt;color:#000"></textarea></span></fieldset>
	...
	<table width="100%" border="0" cellspacing="3" cellpadding="0">
      <tr>
        <td width="18%">When interacting with staff of the KEBS CB: Do you feel valued? &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
Yes </td>
      ...
      <tr>
        <td>Do you get adequate information for any queries you make to the CB? &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
Yes </td>
	...
	<fieldset style="border-color:#000000; border-width:1px">
	<legend style="font-weight:bold;border-color:#000000; border-width:1px;color:#0066CC"><strong>SECTION E: Competence </strong>:</legend>
