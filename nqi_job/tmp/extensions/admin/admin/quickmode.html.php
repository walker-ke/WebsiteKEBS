            ...
            JQuery('joomla-toolbar-button').click( function(e){
                ...
                switch (pressbutton) {
                    ...
                    case 'preview':
                        ...
                        jQuery('#adminForm').get(0).onsubmit = function(){ return false; };
                        jQuery('body').append('<a id="bfPreviewModalButton" href="#bfPreviewModal" data-toggle="modal">Preview</a>');
                        jQuery('#bfPreviewModalButton').css('display','none');
                        jQuery('#bfPreviewModalButton').trigger('click');
                        jQuery('#bfPreviewModalButton').remove();

                        break;
                    case 'preview_site':

                        jQuery('#adminForm').get(0).onsubmit = function(){ return false; };
                        jQuery('body').append('<a id="bfPreviewModalButton2" href="#bfPreviewModal2" data-toggle="modal">Preview</a>');
                        jQuery('#bfPreviewModalButton2').css('display','none');
                        jQuery('#bfPreviewModalButton2').trigger('click');
                        jQuery('#bfPreviewModalButton2').remove();
                                    ...
                                    <div class="bfProperties" id="bfPageProperties" style="display:none">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="bfPropertyWrap">
                                                ...
                                                <a href="#bfPropertiesIntroModal" data-toggle="modal"><?php echo BFText::_( 'COM_BREEZINGFORMS_EDIT_INTRO' ); ?></a>
                                            ...
                                            <div class="bfPropertyWrap bfTrans">
                                                ...
                                                <a href="#bfPropertiesIntroModal2" data-toggle="modal"><?php echo BFText::_( 'COM_BREEZINGFORMS_EDIT_INTRO' ); ?></a>
                                    ...
                                    <div class="bfProperties" id="bfSectionProperties" style="display:none">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="bfPropertyWrap">
                                                ...
                                                <a href="#bfPropertiesDescriptionModal" data-toggle="modal"><?php echo BFText::_( 'COM_BREEZINGFORMS_EDIT_DESCRIPTION' ); ?></a>
                                            ...
                                            <div class="bfPropertyWrap bfTrans">
                                                ...
                                                <a href="#bfPropertiesDescriptionModal2" data-toggle="modal"><?php echo BFText::_( 'COM_BREEZINGFORMS_EDIT_DESCRIPTION' ); ?></a>
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div id="bfThemeBootstrapDiv" style="display:none;">
                                                                    ...
                                                                    <div class="bfPropertyWrap" style="display:none;">
                                                                        ...
                                                                        <input checked="checked" onclick="JQuery('#bfThemeBootstrap').css('display','block');JQuery('#bfThemeBootstrap3').css('display','none');" type="radio" name="bfThemeBootstrapUse3"
                                                                               value=""
