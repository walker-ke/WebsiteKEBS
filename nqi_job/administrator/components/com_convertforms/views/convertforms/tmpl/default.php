...
<div class="<?php echo defined('nrJ4') ? 'row' : 'row-fluid' ?> dashboard">
	...
	<span class="span4 col-md-4">
		<?php if (!$downloadKey) { 
				$framework = NRFramework\Extension::getFramework();
				$editURL = JRoute::_('index.php?option=com_plugins&view=plugin&task=plugin.edit&extension_id=' . $framework['extension_id']);
			?>
			<div class="alert alert-info mt-0">
				...
				<p class="mb-0"><a class="btn btn-small btn-sm btn-primary" href="<?php echo $editURL ?>">
