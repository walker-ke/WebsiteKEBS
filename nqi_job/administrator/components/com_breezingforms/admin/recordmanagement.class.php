            ...
            jQuery("joomla-toolbar-button").click( function(e){
                ...
                switch (pressbutton) {
                    case "csvimport":
                        ...
                        jQuery("#bfCsvModalButton").remove();
                        
                        jQuery("body").append(\'<a id="bfCsvModalButton" href="#bfCsvModal" data-toggle="modal">CSV</a>\');
                        ...
                        jQuery("#bfCsvModalButton").css("display","none");
                        jQuery("#bfCsvModalButton").click();
                        jQuery("#bfCsvModalButton").remove();
