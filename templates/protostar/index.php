...
<div class="col-md-12 latestnews">
	<jdoc:include type="modules" name="latestnews" style="none" />
     ...
     <div class="row ">
<div class="col-md-4">
	<jdoc:include type="modules" name="latestnews1" style="xhtml" />
</div> 
<div class="col-md-4 eventscalender">
	<jdoc:include type="modules" name="UpcomingEvents" style="xhtml" />
</div> 
<div class="col-md-4">
	<jdoc:include type="modules" name="Tender/EOI" style="xhtml" />
</div>   
</div>   
  </div>
</section>
<section class="quality">
	<div class="container latestnews">
		<div class="row">
		<div class="col-md-12">
  			<jdoc:include type="modules" name="quality" style="none" />
  		</div>
		</div>
	</div>
</section>
<section class="marks1">
	<div class="container marks">
		<div class="row">
			<div class="col-md-3 logof"><jdoc:include type="modules" name="Fortification" style="none" /></div>
			<div class="col-md-3 markf"><jdoc:include type="modules" name="Starndardization" style="none" /></div>
			<div class="col-md-3 markd"><jdoc:include type="modules" name="Diamond" style="none" /></div>
			<div class="col-md-3 mark1"><jdoc:include type="modules" name="Import" style="none" /></div>
		</div>
      <div class="row">
       <div class="col-md-12">
         <jdoc:include type="modules" name="smark" style="none" />
        </div>
      </div>
	</div>
</section>
  <section class="buykenyaheading">
    <div class="container latestnews">
        	<div class="row">
  		<div class="col-md-8">
  			<jdoc:include type="modules" name="websites" style="none" />
  		</div>
  				<div class="col-md-4">
  			<jdoc:include type="modules" name="mailing" style="none" />
  		</div>
  	</div>
    </div>
  </section>
  <section class="buykenya2">
  <div class="container">
    <div class="row buykenya1 buykenya">
      <div class="col-md-12">
      	<jdoc:include type="modules" name="export" style="none" />
      </div>
    </div>
  </div>
</section>
<!--<section class="request1">
  <div class="container">
    <div class="row">
      <div class="col-md-4"></div>
      <div class="col-md-4 qoute1">
      	<jdoc:include type="modules" name="Qoute" style="none" />
      </div>
      <div class="col-md-4"></div>
    </div>
  </div>
