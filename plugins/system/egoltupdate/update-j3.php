	...
	private function install($update)
	{
		...
		if (strpos($url, 'www.egolt.com') == true) {
			...
			if((!$public) or (!$private))
			{
				...
				JError::raiseWarning('', JText::_('Error1: License is empty. Go to <a href="http://www.egolt.com/pricing/" target="_blank" >Egolt Website</a> and buy this product\'s subscription. After that download the product and install it.'));
				return false;
			}
		...
		if($egupdate)
		{
			...
			else
			{
				...
				if($encstr == 4)
				{
					JError::raiseWarning('', JText::_('Error4: License is empty. Go to <a href="http://www.egolt.com/pricing/" target="_blank" >Egolt Website</a> and buy this product\'s subscription. After that download the product and install it.'));
					return false;
				}
				elseif($encstr == 5)
				{
					JError::raiseWarning('', JText::_('Error5: License is invalid or expired for this commercial product. Go to <a href="http://www.egolt.com/pricing/" target="_blank" >Egolt Website</a> and buy this product\'s subscription. After that download the product and install it.'));
					return false;
				}
				elseif($encstr == 6)
				{
					JError::raiseWarning('', JText::_('Error6: License is invalid or expired for this commercial product. Go to <a href="http://www.egolt.com/pricing/" target="_blank" >Egolt Website</a> and buy this product\'s subscription. After that download the product and install it.'));
					return false;
				}
			}
		}
