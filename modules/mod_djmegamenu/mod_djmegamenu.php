<?php 
/**
 * @version $Id: mod_djmegamenu.php 68 2017-05-31 09:54:52Z szymon $
 * @package DJ-MegaMenu
...
$ver = modDJMegaMenuHelper::getVersion();
...
if($mobilemenu) {
	...
	$doc->addScript(JURI::root(true).'/modules/mod_djmegamenu/assets/js/'.($jquery ? 'jquery.':'').'djmobilemenu.js?v='.$ver, 'text/javascript', $canDefer);
