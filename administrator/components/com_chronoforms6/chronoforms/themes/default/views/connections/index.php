	...
	<div class="ui">
		<div class="ui labeled icon dropdown button compact pointing blue">
			...
			<div class="menu">
				...
				<a class="item" href="<?php echo r2('index.php?ext=chronoforms&cont=connections&act=demoslist'); ?>">
					<?php el('Demo form'); ?>
				</a>
			</div>
		</div>
	...
	<table class="ui selectable table attached">
		...
		<tbody>
			...
			<tr>
				...
				<?php if(!empty($connection['Connection']['models'])): ?>
				<td>
					<a href="<?php echo r2('index.php?ext=chronoforms&cont=lists&form_id='.$connection['Connection']['id']); ?>" target="_blank"><i class="icon list large"></i></a>
				</td>
				<?php else: ?>
				...
				<td>
					<?php if(!empty($connection['Connection']['params']['log']['enabled'])): ?>
					<a href="<?php echo r2('index.php?ext=chronoforms&cont=logs&form_id='.$connection['Connection']['id']); ?>" target="_blank"><i class="icon database"></i></a>
					<?php endif; ?>
				</td>
			</tr>
			<?php endforeach; ?>
