    ...
    <div class="uk-grid">
        <div class="uk-width-medium-1-4" style="border-right:solid 1px #dddddd;">
            <div class="uk-panel" style="padding-right:20px;height:1000px;">
	            	...
	            	<h3 class="uk-text-center">Edit Template - Table</h3>
	            	<hr class="uk-margin-bottom" />
	            	
	            	<div class="uk-text-center" id="art-data-loading-controls" style="width:100%;margin-top:150px;">
						<div style="font-size:25px;"><i class="uk-icon-spinner uk-icon-spin"></i> loading controls...</div>
					</div>
	            	<div id="art-data-controls-container" style="display:none;">
									...
									<div class="uk-grid" style="margin-top:15px;margin-bottom:15px;">
									    <div class="uk-width-medium-1-2">
										    ...
										    <div class="uk-form-row">
										        ...
										        <div class="uk-form-controls">
													<input type="text" class="uk-width-1-1" name="art-data-new-table-th-font-size" id="art-data-new-table-th-font-size" value="14px" onblur="toggleThFontSizeStylePreview(this.value)">
										        </div>
										    </div>
