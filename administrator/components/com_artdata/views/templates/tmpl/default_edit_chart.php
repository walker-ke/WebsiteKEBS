...
?>
<script>ArtDataChart.config = JSON.parse('<?php echo $this->item->content; ?>');</script>
<div class="art-data-body art-data-body-preview">
                ...
                <form class="uk-form" action="index.php?option=com_artdata&amp;task=Templates.save" method="post" name="TemplateForm" id="TemplateForm">
                    <div class="art-data-accordion" id="art-data-new-accordion" data-art-data-accordion='["chart"]'>
                            ...
                            <div class="uk-grid" style="margin-top:15px;margin-bottom:15px;">
                                    ...
                                    <div class="uk-form-row uk-text-center">
                                        ...
                                        <div class="uk-form-controls uk-width-1-1">
                                            <div class="art-data-colorpicker-container">
                                                <?php $bgColor = (property_exists($this->tmpl_content->graph,'bgcolor')) ? $this->tmpl_content->graph->bgcolor : '#ffffff' ; ?>
                                                <div class="uk-float-left" style="padding-right:5px;">
                                                    <input type="text" style="width:90px;" name="art-data-chart-background" id="art-data-chart-background" value="<?php echo $bgColor; ?>">
                                                </div>  
                                                <div class="uk-float-left">
                                                    <div class="art-data-square-palette-item" id="art-data-chart-background-preview" style="margin:0;width:29px;height:29px;border-radius:4px;background-color:<?php echo $bgColor; ?>;">&nbsp;</div>
                                                </div>  
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="uk-width-medium-1-2">   
                                    ...
                                    <div class="uk-form-row uk-text-center">
                                        ...
                                        <div class="uk-form-controls uk-width-1-1">
                                            <?php $opacity = (property_exists($this->tmpl_content->graph,'opacity')) ? $this->tmpl_content->graph->opacity : 1 ; ?>
                                            <select name="art-data-chart-opacity" id="art-data-chart-opacity" onchange="modifyChartConfig('opacity',this.value)">
                                                ...
                                                <?php foreach ($opacityChoices as $choice) { ?>
                                                        <?php if ( ($choice / 100) == $opacity ) { ?>
                                                                    <option selected="selected" value="<?php echo $choice / 100; ?>"><?php echo $choice; ?>%</option>
                                                        <?php } else { ?>
                            ...
                            <div class="uk-grid" style="margin-top:15px;margin-bottom:15px;">
                                <div class="uk-width-medium-1-2">
                                    ...
                                    <div class="uk-form-row uk-text-center">
                                        ...
                                        <div class="uk-form-controls uk-width-1-1">
                                              <?php $width = (property_exists($this->tmpl_content->dimension,'width')) ? $this->tmpl_content->dimension->width : 400 ; ?>
                                              <input type="text" style="width:90px;" name="art-data-chart-width" id="art-data-chart-width" onblur="modifyChartConfig('width',this.value)" value="<?php echo $width; ?>"> 
                                        </div>
                                    </div>
                                ...
                                <div class="uk-width-medium-1-2">   
                                    ...
                                    <div class="uk-form-row uk-text-center">
                                        ...
                                        <div class="uk-form-controls uk-width-1-1">
                                            <?php $height = (property_exists($this->tmpl_content->dimension,'height')) ? $this->tmpl_content->dimension->height : 400 ; ?>
                                            <input type="text" style="width:90px;" name="art-data-chart-height" id="art-data-chart-height" onblur="modifyChartConfig('height',this.value)" value="<?php echo $height; ?>"> 
                                        </div>
                                    </div>
                            ...
                            <div class="uk-grid" style="margin-top:15px;margin-bottom:15px;">
                                <div class="uk-width-medium-1-2">
                                    ...
                                    <div class="uk-form-row uk-text-center">
                                        ...
                                        <div class="uk-form-controls uk-width-1-1">
                                            <div class="art-data-colorpicker-container">
                                                <div class="uk-float-left" style="padding-right:5px;">
                                                    <?php $axisLineColor = (property_exists($this->tmpl_content->axis,'strokecolor')) ? $this->tmpl_content->axis->strokecolor : '#000000' ; ?>
                                                    <input type="text" style="width:90px;" name="art-data-chart-axis-color" id="art-data-chart-axis-color" value="<?php echo $axisLineColor; ?>" >
                                                </div>  
                                                <div class="uk-float-left">
                                                    <div class="art-data-square-palette-item" id="art-data-chart-axis-color-preview" style="margin:0;width:29px;height:29px;border-radius:4px;background-color:<?php echo $axisLineColor; ?>">&nbsp;</div>
                                                </div>  
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="uk-width-medium-1-2">                                    
                                    ...
                                    <div class="uk-panel uk-text-center" style="height:35px;">
                                        <div>Show Ticks</div>
                                        <div>
                                            <?php $showTicks = (property_exists($this->tmpl_content->axis,'showticks')) ? $this->tmpl_content->axis->showticks : true ; ?>
                                            <?php if ($showTicks == true) { ?>
                                            ...
                                            <?php } else { ?>
                                                    <i style="cursor:pointer;font-size:30px;color:rgba(216, 80, 48, 1);" class="uk-icon-toggle-off" onclick="toggleNewIcon(1,'showTicks','art-data-chart-axis-show-ticks')" id="art-data-chart-axis-show-ticks"></i>
                                            <?php } ?>
                                        </div>                              
                                    </div>
                            ...
                            <div class="uk-grid" style="margin-top:15px;margin-bottom:15px;">
                                <div class="uk-width-medium-1-2">
                                    ...
                                    <div class="uk-form-row uk-text-center">
                                        ...
                                        <div class="uk-form-controls uk-width-1-1">
                                            <?php $ticks = (property_exists($this->tmpl_content->axis,'ticks')) ? $this->tmpl_content->axis->ticks : 8 ; ?>
                                            <input type="text" style="width:90px;" name="art-data-chart-axis-ticks" id="art-data-chart-axis-ticks" onblur="modifyChartConfig('ticks',this.value)" value="<?php echo $ticks; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="uk-width-medium-1-2">                                    
                                    ...
                                    <div class="uk-form-row uk-text-center">
                                        ...
                                        <div class="uk-form-controls uk-width-1-1">
                                            <?php $padding = (property_exists($this->tmpl_content->axis,'padding')) ? $this->tmpl_content->axis->padding : 5 ; ?>
                                            <input type="text" style="width:90px;" name="art-data-chart-axis-padding" id="art-data-chart-axis-padding" onblur="modifyChartConfig('axispadding',this.value)" value="<?php echo $this->tmpl_content->axis->padding; ?>"> 
                                        </div>
                                    </div>
                        ...
                        <div id="art-data-accordion-content-palette" class="uk-margin-bottom" style="display:none;">
                            ...
                            <?php foreach ($this->tmpl_content->graph->custompalette as $key => $color) { ?>
                    ...
                    <input type="hidden" name="art-data-edit-id" id="art-data-edit-id" value="<?php echo $this->item->id; ?>">
                </form>
                ...
                <form class="uk-form">
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            <input name="art-data-new-template-name" id="art-data-new-template-name" class="uk-form-large uk-width-1-1" type="text" value="<?php echo $this->item->name; ?>" data-uk-tooltip title="<?php echo JText::_( 'COM_ARTDATA_NAME_FIELD_TOOLTIP' ); ?>">
                        </div>
                    </div>   
                </form>
            </div>
